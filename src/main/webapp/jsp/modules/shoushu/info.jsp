            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">手术记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="huanzheId" name="huanzheId" v-model="ruleForm.huanzheId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shoushuName" name="shoushuName" class="form-control"
                                               v-model="ruleForm.shoushuName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>手术类型</label>
                                    <input id="shoushuValue" name="shoushuValue" class="form-control"
                                           v-model="ruleForm.shoushuValue" readonly>
                                </div>


                                    <div class="form-group col-md-6">
                                        <label>手术时间</label>
                                        <input id="shoushuTime" name="shoushuTime" class="form-control"
                                               v-model="ruleForm.shoushuTime" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.shoushuContent != null && ruleForm.shoushuContent != 'null' && ruleForm.shoushuContent != '') {
            var shoushuContentUeditor = UE.getEditor('shoushuContentEditor');
                shoushuContentUeditor.ready(function () {
                    var mes = '' + ruleForm.shoushuContent;
                    shoushuContentUeditor.setContent(mes);
                    shoushuContentUeditor.setDisabled('fullscreen');
            });
        }
    }

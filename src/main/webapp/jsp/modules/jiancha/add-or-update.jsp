    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑检查记录</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑检查记录</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">检查记录信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="huanzheId" name="huanzheId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>检查时间</label>
                                        <input id="jianchaTime-input" name="jianchaTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>检查详情</label>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                jianchaTime: "required",
                jianchaContent: "required",
            },
            messages: {
                huanzheId: "患者不能为空",
                jianchaName: "检查名字不能为空",
                jianchaTypes: "检查类型不能为空",
                jianchaTime: "检查时间不能为空",
                jianchaContent: "检查详情不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jianchaTime-input").val(ruleForm.jianchaTime);

    ...
    <!-- 本表的查询条件 -->
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("huanzhe/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addhuanzhe", "addhuanzhe");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("huanzhe/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){

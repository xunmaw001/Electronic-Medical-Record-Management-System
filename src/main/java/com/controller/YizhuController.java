    ...
    */
    ...
    public R info(@PathVariable("id") Long id){
        ...
        if(yizhu !=null){
            ...
            //级联表
            HuanzheEntity huanzhe = huanzheService.selectById(yizhu.getHuanzheId());
            if(huanzhe != null){
    ...
    */
    ...
    public R save(@RequestBody YizhuEntity yizhu, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            yizhu.setHuanzheId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
//        Wrapper<YizhuEntity> queryWrapper = new EntityWrapper<YizhuEntity>()
//            .eq("huanzhe_id", yizhu.getHuanzheId())

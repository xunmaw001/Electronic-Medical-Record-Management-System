    ...
    */
    ...
    public R info(@PathVariable("id") Long id){
        ...
        if(jiancha !=null){
            ...
            //级联表
            HuanzheEntity huanzhe = huanzheService.selectById(jiancha.getHuanzheId());
            if(huanzhe != null){
    ...
    */
    ...
    public R save(@RequestBody JianchaEntity jiancha, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            jiancha.setHuanzheId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
//        Wrapper<JianchaEntity> queryWrapper = new EntityWrapper<JianchaEntity>()
//            .eq("huanzhe_id", jiancha.getHuanzheId())

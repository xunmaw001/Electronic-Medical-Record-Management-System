 ...
 */
@TableName("huli")
public class HuliView extends HuliEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		/**
		* 护理类型的值
		*/
		private String huliValue;
	...
	public HuliView(HuliEntity huliEntity) {
		try {
			BeanUtils.copyProperties(this, huliEntity);
			...
			* 获取： 护理类型的值
			*/
			public String getHuliValue() {
				return huliValue;
			}
			/**
			* 设置： 护理类型的值
			*/
			public void setHuliValue(String huliValue) {
				this.huliValue = huliValue;
			}
